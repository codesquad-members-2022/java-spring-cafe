...
insert into `article` (`title`, `writer`, `contents`, `date`)
values ('JDBC사용법1', 'geombong1', '너무 어렵다1', now() - 5);
insert into `article` (`title`, `writer`, `contents`, `date`)
values ('JDBC사용법2', 'geombong2', '너무 어렵다2', now() - 4);
insert into `article` (`title`, `writer`, `contents`, `date`)
values ('JDBC사용법3', 'geombong3', '너무 어렵다3', now() - 3);
insert into `article` (`title`, `writer`, `contents`, `date`)
values ('JDBC사용법4', 'geombong4', '너무 어렵다4', now() - 2);
insert into `article` (`title`, `writer`, `contents`, `date`)
values ('JDBC사용법5', 'geombong5', '너무 어렵다5', now() - 1);
