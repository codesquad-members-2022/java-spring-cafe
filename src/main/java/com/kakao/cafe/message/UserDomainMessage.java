...
public class UserDomainMessage {

    public static final String NO_SUCH_USER_MESSAGE = "존재하지 않는 회원입니다.";
    public static final String DUPLICATE_USER_MESSAGE = "이미 존재하는 회원입니다.";
