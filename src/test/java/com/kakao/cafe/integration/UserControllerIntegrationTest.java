...
public class UserControllerIntegrationTest {
    ...
    @DisplayName("사용자가 회원 목록을 요청을 했을 때 /user/list view를 반환한다.")
    @Test
    ...
    @DisplayName("사용자가 특정 회원 프로필을 요청을 했을 때 /user/profile view를 반환한다.")
    @Test
    void 회원_프로필_보기() throws Exception {
        // given
        UserRequestDto userRequestDto = new UserRequestDto("ikjo", "1234", "조명익", "auddlr100@naver.com");
    ...
    @DisplayName("사용자가 회원 정보 수정 화면을 요청 했을 때 /user/updateForm view를 반환한다.")
    @Test
